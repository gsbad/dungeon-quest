...
LEVEL_MAPS = {
    ...
    12: {  # Boss level - Act 3 finale (Stage Q2: no longer the campaign
        # end - chains into Act 4 now that levels 14+ exist. Level 25 is
        # the new "victory" finale; see CAMPAIGN_FINAL_LEVEL below.
        "type": "boss",
        "boss": "shadow_king",
        "next": 14,
        "victory": None,
    ...
    # ─── Stage Q2: Atos 4-6 + boss secreto novo ─────────────────────────
    # 3 Atos novos, cada um 2 fases de combate + 2 bosses (mais denso que
    # os 3 Atos originais, que eram 3 combate + 1 boss) - ver plano em
    # .claude/plans/jiggly-whistling-valley.md. monster_level continua a
    # progressao linear +4 das fases de combate originais (1,4,8,...,32).
    # Fase 12 agora encadeia pra 14 (deixou de ser o fim de campanha - ver
    # o "next"/"victory" editado la em cima); fase 25 e a nova finale.

    # Ato 4 - "O Reino Selvagem" (Lobo/Urso -> Ursa Ancestral, Aranha/Sapo -> Imperatriz das Aranhas)
    14: {
        "type": "combat",
        "boss": None,
        "next": 15,
        ...
        "floor": "grass",
        "bg": (18, 60, 22),
        "title": "Trilha da Alcateia",
        "description": "Uma trilha encharcada nas profundezas da floresta, disputada por lobos e ursos - inicio do Ato 4.",
        "enemies": ["lobo", "urso"],
        "layout": [
            "####################",
            "#..................#",
    ...
    15: {  # Boss level - Ato 4, primeiro boss
        "type": "boss",
        "boss": "ursa_ancestral",
        "next": 16,
        "victory": None,
        ...
        "floor": "boss_floor",
        "bg": (25, 35, 20),
        "title": "Covil da Ursa Ancestral",
        "description": "Uma caverna funda no coracao da floresta, lar da matriarca lendaria da alcateia.",
        "enemies": [],
        "layout": [
            "####################",
            "#..................#",
    ...
    16: {
        ...
        "floor": "swamp",
        "bg": (30, 45, 25),
        "title": "Teia Esquecida",
        "description": "Um brejo coberto de teias antigas, onde aranhas e sapos disputam cada palmo de lama.",
        "enemies": ["aranha", "sapo"],
        "layout": [
            "####################",
            "#..................#",
    ...
    17: {  # Boss level - Ato 4 finale
        "type": "boss",
        "boss": "imperatriz_aranha",
        "next": 18,
        "victory": None,
        "weather": "gloom",
        "tileset": "crypt_floor",
        "floor": "crypt_floor",
        "bg": (25, 15, 30),
        "title": "Covil da Imperatriz",
        "description": "O centro do ninho, onde a Imperatriz das Aranhas tece sua teia final - fim do Ato 4.",
        "enemies": [],
        "layout": [
            "####################",
            "#..................#",
    ...
    # Ato 5 - "Profundezas Amaldicoadas" (Vampiro/Fantasma -> Barao Sanguinario, Golem/Caranguejo -> Colosso Runico)
    18: {
        "type": "combat",
        "boss": None,
        "next": 19,
        ...
        "floor": "crypt_floor",
        "bg": (20, 12, 25),
        "title": "Cripta dos Sussurros",
        "description": "Uma cripta onde vampiros e fantasmas se alimentam da penumbra eterna - inicio do Ato 5.",
        "enemies": ["vampiro", "fantasma"],
        "layout": [
            "####################",
            "#..................#",
            "#..................#",
    ...
    19: {  # Boss level - Ato 5, primeiro boss
        "type": "boss",
        "boss": "barao_sanguinario",
        "next": 20,
        "victory": None,
        "weather": None,
        "tileset": "ritual_floor",
        "floor": "ritual_floor",
        "bg": (30, 8, 15),
        "title": "Salao do Barao Sanguinario",
        "description": "Um salao ritualistico onde o Barao recebe seus convidados - nenhum jamais saiu vivo.",
        "enemies": [],
        "layout": [
            "####################",
            "#..................#",
    ...
    20: {
        ...
        "floor": "abyss_floor",
        "bg": (22, 22, 28),
        "title": "Salao de Ferro e Pedra",
        "description": "Uma camara subterranea onde golens e caranguejos blindados guardam runas antigas.",
        "enemies": ["golem", "caranguejo"],
        "layout": [
            "####################",
            "#..................#",
            "#..................#",
    ...
    21: {  # Boss level - Ato 5 finale
        ...
        "floor": "cursed_floor",
        "bg": (18, 18, 24),
        "title": "Nucleo do Colosso Runico",
        "description": "A camara-nucleo onde o Colosso Runico foi forjado - fim do Ato 5.",
        "enemies": [],
        "layout": [
            "####################",
            "#..................#",
    ...
    # Ato 6 - "Covil Arcano" (Bruxa/Saurio -> Arquibruxa, Lobisomem/Minotauro -> Senhor da Alcateia)
    22: {
        "type": "combat",
        "boss": None,
        "next": 23,
        ...
        "floor": "swamp",
        "bg": (28, 20, 35),
        "title": "Pantano da Convocacao",
        "description": "Um brejo enevoado onde bruxas e reptilianos conduzem rituais proibidos - inicio do Ato 6.",
        "enemies": ["bruxa", "saurio"],
        "layout": [
            "####################",
            "#..................#",
            "#..................#",
    ...
    23: {  # Boss level - Ato 6, primeiro boss
        "type": "boss",
        "boss": "arquibruxa",
        "next": 24,
        "victory": None,
        ...
        "floor": "ritual_floor",
        "bg": (25, 10, 35),
        "title": "Covil da Arquibruxa",
        "description": "O covil onde a Arquibruxa comanda seu covil de seguidoras.",
        "enemies": [],
        "layout": [
            "####################",
            "#..................#",
    ...
    24: {
        ...
        "floor": "grass",
        "bg": (35, 35, 45),
        "title": "Vale da Alcateia Selvagem",
        "description": "Um vale gelado onde lobisomens e minotauros disputam territorio - o ultimo trecho antes do trono.",
        "enemies": ["lobisomem", "minotauro"],
        "layout": [
            "####################",
            "#..................#",
            "#..................#",
    ...
    25: {  # Boss level - Ato 6 finale, NOVA fase final da campanha
        "type": "boss",
        "boss": "senhor_da_alcateia",
        "next": None,
        "victory": "victory",
        "weather": "fog",
        "tileset": "throne_floor",
        "floor": "throne_floor",
        "bg": (20, 15, 15),
        "title": "Trono do Senhor da Alcateia",
        "description": "O trono selvagem onde o Senhor da Alcateia reina - o confronto final da campanha.",
        "enemies": [],
        "layout": [
            "####################",
            "#..................#",
    ...
    26: {  # Segundo boss secreto (Stage Q2) - mesmo mecanismo de
        # desbloqueio/acesso da fase 13 (ver VictoryState em game/states.py),
        # nao faz parte da corrente "next" principal.
        "type": "boss",
        "boss": "dragao_primordial",
        "next": None,
        "victory": "secret_victory",
        "weather": "storm",
        "tileset": "lava",
        "floor": "lava",
        "bg": (30, 12, 8),
        "title": "Fase Secreta: Furia do Dragao",
        "description": "Um covil vulcanico escondido alem do Ato 6, onde dorme o Dragao Primordial.",
        "enemies": [],
        "layout": [
            "####################",
            "#..................#",
