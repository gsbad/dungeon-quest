...
ENEMY_FLAVOR = {
    ...
    # Estagio N (leva de conteudo - familias de monstro): tier 1 = so
    # melee (as vezes com melee_status), tier 2 = melee_status mais forte
    # + as vezes ranged, tier 3 = melee_status + ranged + ranged_shape -
    # os 5 campos combinaveis ja bastam pra diferenciar os 3 tiers de cada
    # familia sem nenhum codigo novo (confirmado na pesquisa antes deste
    # estagio).
    "rato":              {"atk_cd": 0.7, "color": (150,130,110), "melee_status": ("poison", 0.20)},
    "rato_gigante":      {"atk_cd": 0.8, "color": (120,100,85),  "melee_status": ("poison", 0.30)},
    "rato_toxico":       {"atk_cd": 0.9, "color": (90,140,60),   "melee_status": ("poison", 0.45),
                            "ranged": {"color": (140,200,80), "status_effect": "poison", "status_chance": 0.3, "speed": 200},
                            "ranged_shape": "spread3"},
    "sapo":              {"atk_cd": 1.1, "color": (90,140,70),   "melee_status": ("poison", 0.20)},
    "sapo_venenoso":     {"atk_cd": 1.2, "color": (110,160,50),  "melee_status": ("poison", 0.35)},
    "sapo_rei":          {"atk_cd": 1.3, "color": (150,180,40),  "melee_status": ("poison", 0.45),
                            "ranged": {"color": (170,220,60), "status_effect": "poison", "status_chance": 0.3, "speed": 190},
                            "ranged_shape": "circle6"},
    "minotauro_jovem":   {"atk_cd": 1.3, "color": (140,100,60),  "melee_status": ("weakness", 0.20)},
    "minotauro":         {"atk_cd": 1.5, "color": (110,75,45),   "melee_status": ("weakness", 0.30)},
    "minotauro_ancestral": {"atk_cd": 1.6, "color": (80,55,35),  "melee_status": ("weakness", 0.40),
                            "ranged": {"color": (200,150,90), "status_effect": "weakness", "status_chance": 0.3, "speed": 210},
                            "ranged_shape": "spread3"},
    "lobo":              {"atk_cd": 0.8, "color": (140,140,145), "melee_status": ("slow", 0.20)},
    "lobo_alfa":         {"atk_cd": 0.85, "color": (100,100,110), "melee_status": ("slow", 0.30)},
    "lobo_das_sombras":  {"atk_cd": 0.9, "color": (50,50,65),    "melee_status": ("slow", 0.40),
                            "ranged": {"color": (100,90,140), "status_effect": "slow", "status_chance": 0.3, "speed": 230},
                            "ranged_shape": "spread5"},
    "urso":              {"atk_cd": 1.4, "color": (120,85,55),   "melee_status": ("weakness", 0.20)},
    "urso_da_matilha":   {"atk_cd": 1.5, "color": (95,65,40),    "melee_status": ("weakness", 0.30)},
    "urso_ancestral":    {"atk_cd": 1.6, "color": (60,45,30),    "melee_status": ("weakness", 0.45)},
    "orc_recruta":       {"atk_cd": 1.0, "color": (90,140,70),   "melee_status": ("weakness", 0.20)},
    "orc_guerreiro":     {"atk_cd": 1.1, "color": (70,115,55),   "melee_status": ("weakness", 0.30)},
    "orc_brutamontes":   {"atk_cd": 1.3, "color": (50,90,40),    "melee_status": ("weakness", 0.40),
                            "ranged": {"color": (120,170,90), "status_effect": "weakness", "status_chance": 0.3, "speed": 200},
                            "ranged_shape": "spread3"},
    "drake_jovem":       {"atk_cd": 0.9, "color": (200,90,40),   "melee_status": ("burn", 0.20)},
    "drake":             {"atk_cd": 1.0, "color": (170,60,30),   "melee_status": ("burn", 0.30),
                            "ranged": {"color": (255,140,50), "status_effect": "burn", "status_chance": 0.3, "speed": 230}},
    "drake_anciao":      {"atk_cd": 1.1, "color": (130,40,25),   "melee_status": ("burn", 0.40),
                            "ranged": {"color": (255,110,30), "status_effect": "burn", "status_chance": 0.35, "speed": 240},
                            "ranged_shape": "circle6"},
    "servo_vampirico":   {"atk_cd": 0.9, "color": (90,50,70),    "melee_status": ("weakness", 0.20)},
    "vampiro":           {"atk_cd": 0.85, "color": (60,30,50),   "melee_status": ("weakness", 0.30)},
    "lorde_vampiro":     {"atk_cd": 0.8, "color": (35,15,30),    "melee_status": ("weakness", 0.45),
                            "ranged": {"color": (150,30,60), "status_effect": "weakness", "status_chance": 0.35, "speed": 240},
                            "ranged_shape": "spread5"},
    "espectro":          {"atk_cd": 1.0, "color": (200,210,230), "melee_status": ("chill", 0.20)},
    "fantasma":          {"atk_cd": 0.95, "color": (170,185,220), "melee_status": ("chill", 0.30)},
    "espirito_vingativo": {"atk_cd": 0.9, "color": (130,150,210), "melee_status": ("chill", 0.40),
                            "ranged": {"color": (180,200,255), "status_effect": "chill", "status_chance": 0.3, "speed": 220},
                            "ranged_shape": "circle6"},
    "geleia":            {"atk_cd": 1.2, "color": (110,200,110), "melee_status": ("poison", 0.20)},
    "geleia_acida":      {"atk_cd": 1.3, "color": (150,220,60),  "melee_status": ("poison", 0.35)},
    "geleia_real":       {"atk_cd": 1.4, "color": (200,190,40),  "melee_status": ("poison", 0.45),
                            "ranged": {"color": (220,210,60), "status_effect": "poison", "status_chance": 0.3, "speed": 170},
                            "ranged_shape": "circle6"},
    "caranguejo":        {"atk_cd": 1.1, "color": (200,90,60)},
    "caranguejo_blindado": {"atk_cd": 1.2, "color": (170,70,50)},
    "rei_caranguejo":    {"atk_cd": 1.3, "color": (140,50,40),
                            "ranged": {"color": (220,120,80), "status_effect": None, "status_chance": 0.0, "speed": 190},
                            "ranged_shape": "spread3"},
    "licantropo":        {"atk_cd": 0.9, "color": (110,90,70),   "melee_status": ("weakness", 0.20)},
    "lobisomem":         {"atk_cd": 0.85, "color": (85,65,50),   "melee_status": ("weakness", 0.30)},
    "lobisomem_alfa":    {"atk_cd": 0.8, "color": (55,40,30),    "melee_status": ("weakness", 0.45),
                            "ranged": {"color": (140,110,80), "status_effect": "weakness", "status_chance": 0.35, "speed": 230},
                            "ranged_shape": "spread5"},

    # --- Novos tiers de familias que ja tinham monstro(s) ---
    "aranha_cacadora":   {"atk_cd": 0.85, "color": (75,50,85),   "melee_status": ("poison", 0.35)},
    "rainha_aranha":     {"atk_cd": 0.8, "color": (45,25,55),    "melee_status": ("poison", 0.45),
                            "ranged": {"color": (200,60,60), "status_effect": "poison", "status_chance": 0.3, "speed": 220},
                            "ranged_shape": "circle6"},
    "goblin_guerreiro":  {"atk_cd": 0.75, "color": (60,150,60),  "puddles": True,
                            "ranged": {"color": (150,200,100), "status_effect": None, "status_chance": 0.0, "speed": 230}},
    "lider_goblin":      {"atk_cd": 0.7, "color": (40,120,40),   "puddles": True,
                            "ranged": {"color": (130,190,90), "status_effect": "weakness", "status_chance": 0.25, "speed": 240},
                            "ranged_shape": "spread3"},
    "demonio_menor":     {"atk_cd": 0.9, "color": (170,50,50),   "ranged": {"color": (255,220,100), "status_effect": "shock", "status_chance": 0.25, "speed": 220}},
    "demonio_maior":     {"atk_cd": 0.85, "color": (130,30,30),  "ranged": {"color": (255,200,80), "status_effect": "burn", "status_chance": 0.3, "speed": 230},
                            "ranged_shape": "spread5"},
    "golem_de_ferro":    {"atk_cd": 1.8, "color": (130,130,140), "ranged": {"color": (180,180,190), "status_effect": None, "status_chance": 0.0, "speed": 170},
                            "ranged_shape": "circle6"},
    "golem_runico":      {"atk_cd": 1.7, "color": (90,110,160),  "ranged": {"color": (140,170,255), "status_effect": "shock", "status_chance": 0.25, "speed": 180},
                            "ranged_shape": "circle6"},
    "zumbi_podre":       {"atk_cd": 1.3, "color": (100,120,80),  "melee_status": ("poison", 0.35)},
    "abominacao":        {"atk_cd": 1.4, "color": (80,100,60),   "melee_status": ("poison", 0.45)},
    "saurio_ancestral":  {"atk_cd": 0.85, "color": (30,90,60),   "melee_status": ("poison", 0.35),
                            "ranged": {"color": (100,220,140), "status_effect": "poison", "status_chance": 0.3, "speed": 220},
                            "ranged_shape": "spread5"},
    "bruxa_suprema":     {"atk_cd": 1.1, "color": (40,30,80),    "ranged": {"color": (180,140,255), "status_effect": "weakness", "status_chance": 0.3, "speed": 230},
                            "ranged_shape": "circle6"},
    "ogro_anciao":       {"atk_cd": 1.7, "color": (75,55,25),    "melee_status": ("weakness", 0.35)},
}
